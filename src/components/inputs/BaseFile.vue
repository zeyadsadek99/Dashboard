<template>
  <VeeField type="file" :name="name" v-slot="{ meta, field }">
    ...
    >
      ...
      <div
        class="upload border border-primary/30 hid_input rounded-xl p-2 bg-primary/10"
        :class="{
      ...
      >
        ...
        >
          <img
            class="mx-auto w-[10px] h-[180px] object-cover"
        ...
        <div class="flex gap-2 pb-7">
          ...
          <div class="flex flex-col flex-1">
            <h5 class="flex items-center justify-between">
              ...
              >
                <div
                  class="rounded-full bg-[#047857] flex items-center justify-center text-white border"
                >
                  <GlobalIcons name="check" classes="!size-5" />
                </div>
                  <!-- <button
                    type="button"
                    @click="cancelReq"
                    class="text-primary border size-5 flex items-center justify-center rounded-full border-primary transition hover:bg-primary hover:!text-white"
                  >
                    <GlobalIcons name="close" classes="!size-4" />
                  </button> -->
              </div>
              <div
                class="text-primary font-bold flex items-center gap-2"
              ...
              >
                ...
                <button
                  type="button"
                  @click="cancelReq"
                  class="text-primary border flex items-center justify-center rounded-full border-primary transition hover:bg-primary hover:!text-white"
                >
                  <GlobalIcons name="close" classes="size-4" />
                </button>
              </div>
  ...
  >
    <div class="relative">
      <button
        class="absolute border flex items-center justify-center p-1  bg-primary rounded-full -top-1 -left-1 text-base z-10"
        type="button"
        @click="cancelReq"
      >
        <GlobalIcons name="close" classes="!size-4" />
